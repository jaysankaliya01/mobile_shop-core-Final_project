using mobile_shop_core_.Constants;
using mobile_shop_core_.Models;
using mobile_shop_core_.Models.ViewModels;
using mobile_shop_core_.Repository.IRepository;
using Microsoft.AspNetCore.Mvc;
using Microsoft.EntityFrameworkCore;

namespace mobile_shop_core_.Areas.Customer.Components
{
