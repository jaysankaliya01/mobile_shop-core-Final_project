...
using mobile_shop_core_.Areas.Admin.Controllers;
using mobile_shop_core_.Areas.Customer.Controllers;
using mobile_shop_core_.Controllers;
using ECommercePlatform.Models;
using ECommercePlatform.Repository.IRepository;
using ECommercePlatform.Repository;
using mobile_shop_core_.Data;
using mobile_shop_core_.Helpers.EmailHelper;
